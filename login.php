...
if(isset($_REQUEST['email']))
	...
	$status="Active";
	$query="select * from registration where email='$username' && password='$password' && status='1'   ";
	$rid=mysqli_query($link,$query);
	$userinfo=mysqli_fetch_array($rid);
  ...
  <div class="container">
    ...
    <form class="login-form" action="" method="post">
	  ...
	  <p style="font-size:24px;font-weight:bold;color:#000">MIET Incident Management System</p>
        ...
        <p style="font-weight:bold;font-size:25px;color:#ff0000"><?php echo $error;?></p>
      ...
      <div class="text-right" style="margin-top:10px;color:#000000">  <a href="handler-login.php"> Sign In for Handler</a> </div>
